...
def main(host_, port_):
    ...
    # añade una regla a la base de datos
    print("Añadiendo la siguiente regla a la base de datos: Sensor1 igual 10 --> Interruptor1 ON")
    Regla1 = Regla(regla = "Sensor1 igual 10 --> Interruptor1 ON")
    Regla1.save()
